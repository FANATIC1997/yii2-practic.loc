...
<div class="user-form">
    ...
    <div class="form-group">
		<?
		$model->orgTags = $model->getOrgUsersArray();
		?>
		<?= $form->field($model, 'orgTags')->widget(Select2::classname(), [
			'data' => $orgs,
			'options' => ['placeholder' => ' Выберите организации...', 'multiple' => true],
			'pluginOptions' => [
				'allowClear' => true,
			],
		])->label('Привязанные организации'); ?>
    </div>
    ...
    <div class="form-group">
		<?= $form->field($model, 'role')->dropDownList([
			...
			'manager' => 'Менеджер',
			'user' => 'Пользователь'
		], ['prompt' => 'Выберите уровень...'])->label('Уровень доступа'); ?>
    </div>
